    ...
    return (
      <div className="ShowFoodDetails">
        <div className="container">
          ...
          <div>
            <div style={{ width: '45rem' }} className="container">
              {FoodItem}
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-6">
              <button type="button" style={{ marginLeft: '25rem' }} className="btn btn-danger btn-md" onClick={this.onDeleteClick.bind(this, food._id)}>Delete Food</button><br />
            </div>

            <div className="col-md-6">
              <Link to={`/edit-food/${food._id}`} className="btn btn-info btn-md">
                Edit Food
              </Link>
              <br />
            </div>
